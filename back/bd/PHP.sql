...
ALTER TABLE voiture DROP COLUMN matricule;

ALTER TABLE voiture SET idvoit VARCHAR(10) PRIMARY KEY;

DESCRIBE voiture;

ALTER TABLE place DROP FOREIGN KEY idvoit;

SHOW CREATE TABLE voiture;